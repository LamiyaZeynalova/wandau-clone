// import contactHeroImg from "../../../assets/images/image/homeSlide01.jpg";
    ...
    <section className="contact">
      <div className="container">
        <div className="heroContact">
          {/* <img src={contactHeroImg} alt="heroContact" /> */}
          <div className="row">
        ...
        <div className="formTittle">
          ...
          <div className="centerTitle">
            <h2>Help us to respond to <br /> you more quickly</h2>
          </div>
        </div>
        <div className="formRow">
          <div className="infoForm">
            ...
            <p>
              Please use this number if you know the name of the person <br /> or
              department you would like to contact. Or you can fax <br />020 3461
              4771.
            </p>
