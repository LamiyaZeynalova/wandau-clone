...
//       // scroll-a görə translateX dəyəri hesablanır
//       const offset = scrollY * 0.3; // 0.3 sürəti dəyişə bilərsən (0.1–0.5 arası)
...
//             <img src={aboutImage1} alt="statue" />
//             <img className="secondImg" src={aboutImage2} alt="statue" />
//             <img src={aboutImage3} alt="statue" />
//           </div>
//         </div>
//       </div>
//     </section>
    ...
    const onScroll = () => {
      if (!ticking.current) {
        window.requestAnimationFrame(() => {
          ...
          // sonsuz loop üçün mod operatoru ilə translateX hesablayırıq
