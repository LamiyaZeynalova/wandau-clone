...
import dino from "../../../assets/images/image/artThumb04.jpg"
const Exhibitions = () => {
  return (
...
<div className="mainPartDetails">
  ...
  <div className="info">
    <p><strong>This exhibition</strong> is a rare chance to experience two of Yayoi Kusama’s Infinity Mirror Rooms. These immersive installations will transport you into Kusama’s.</p>
 <p> <strong>Architectural</strong> elements and armatures. Bhabha’s multifaceted work explores colonialism, war, displacement and the memory of home. For her first major survey exhibition in Europe.</p>
  <p> <strong>These immersive</strong> installations will transport you into Kusama’s. This exhibition is a rare chance to experience two of Yayoi Kusama’s Infinity Mirror Rooms.</p>
  </div>
</div>
